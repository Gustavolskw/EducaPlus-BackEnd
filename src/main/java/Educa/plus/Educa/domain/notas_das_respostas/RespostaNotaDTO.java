...
public record RespostaNotaDTO(Long idNota, String titulo,String materia, String enunciado, String questoes, String respostaDoAluno, String respostaCerta, String aluno, String professor, Double nota
) {
    public RespostaNotaDTO(NotasAtividade nota){
        this(
                nota.getIdNotaAtividade(),
                nota.getRespostaAtividade().getAtividade().getTitulo(),
                nota.getRespostaAtividade().getAtividade().getMateria().getMateriaNome(),
